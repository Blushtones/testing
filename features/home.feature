...
When visiting the homepage
  ...
  @header_menu
    ...
    Then I should see "Home" in the "home_page_header" region
		And I should see the link "Incidents" in the "home_page_header" region	
		And I should see the link "News" in the "home_page_header" region
		And I should see the link "Behind The Scenes" in the "home_page_header" region
		And I should see the link "Safety" in the "home_page_header" region
		And I should see the link "Support Us" in the "home_page_header" region
